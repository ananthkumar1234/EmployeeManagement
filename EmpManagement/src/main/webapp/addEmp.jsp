			...
			<div class="form-row">
					...
					<div class="form-section">
						...
						<div class="form-group">
							...
							<input type="text" id="firstName" name="firstName"> <span
								class="error-message" id="fNameError">Please enter
								FirstName.</span>
						</div>
						<div class="form-group">
							<label for="lastName">Last Name<span class="star">*</span></label>
							<input type="text" id="lastName" name="lastName"> <span
								class="error-message" id="lNameError">Please enter
								LastName.</span>
						</div>
						<div class="form-group">
							<label for="dob">Date of Birth<span class="star">*</span></label>
							<input type="text" id="dob" name="dob" placeholder="yyyy-mm-dd">
							<span class="error-message" id="dobError">Please select
								DateOfBirth.</span>
						</div>
						<div class="form-group">
							<label for="gender">Gender<span class="star">*</span></label> <select
								id="gender" name="gender">
								<option value="">Select Gender</option>
								<option value="Male">Male</option>
								<option value="Female">Female</option>
								<option value="Others">Others</option>
							</select> <span class="error-message" id="genderError">Please
								select Gender.</span>
						</div>
						<div class="form-group">
							...
							</select> <span class="error-message" id="msError">Please select
								MaritalStatus.</span>
						</div>
						<div class="form-group">
							<label for="bg">Blood Group<span class="star">*</span></label> <select
								id="bg" name="bg">
							...
							</select> <span class="error-message" id="bgError">Please select
								BloodGroup.</span>
						</div>
					</div>
				</div>
				...
				<div class="form-column">
					<div class="form-section">
						...
						<div class="form-group">
							<label for="phone">Personal Contact Number<span
								class="star">*</span></label> <input type="text" id="phone" name="phone">
							<span class="error-message" id="phoneError">Please enter
								PhoneNumber.</span>
						</div>
						<div class="form-group">
							<label for="email">Personal Email<span class="star">*</span></label>
							<input type="email" id="email" name="email"> <span
								class="error-message" id="emailError">Please enter Valid
								Email.</span>
						</div>
						<div class="form-group">
							<label for="ecn">Emergency Contact Name</label> <input
								type="text" id="ecn" name="ecn">
						</div>
						<div class="form-group">
							<label for="ec">Emergency Contact Number</label> <input
								type="text" id="ec" name="ec">
						</div>
						<div class="form-group">
							<label for="address">Permanent Address<span class="star">*</span></label>
							<textarea id="address" name="address"></textarea>
							<span class="error-message" id="addressError">Please enter
								Valid Address.</span>
						</div>
						<div class="form-group">
							<label for="tempadd">Temporary Address</label> <input type="text"
								id="tempadd" name="tempadd">
						</div>
					</div>
				</div>
			</div>
					...
					<div class="form-section">
						...
						<div class="form-group">
							...
							<input type="text" id="hireDate" name="hireDate"
								placeholder="yyyy-mm-dd"> <span class="error-message"
								id="hireDateError">Please select hireDate.</span>
						</div>
						<div class="form-group">
							<label for="role">Role<span class="star">*</span> <i
								class="fas fa-plus add-role-icon" onclick="openPopup()"></i> <!-- Plus Icon -->
							</label> <select id="role" name="role">
								<option value="">Select Role</option>
								<% for(Roles r : list) { %>
								<option value="<%= r.getRoleId() %>"><%= r.getRoleName() %></option>
								<% } %>
							</select> <span class="error-message" id="roleError">Please select
								Role.</span>
						</div>
					...
					<div class="form-section">
						...
						<div class="form-group">
							...
							<input type="text" id="username" name="username"> <span
								class="error-message" id="unameError">Please enter
								userName.</span>
						</div>
						<div class="form-group">
