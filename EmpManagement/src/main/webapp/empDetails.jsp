...
<div class="container">
    ...
    <div class="filter-form">
        <form action="EmployeeFilterServlet" method="get">
            <select id="role" name="role">
                ...
                for(Roles r : list) { 
                %>
                <option value="<%= r.getRoleId() %>" <%= r.getRoleId() == roleid ? "selected" : "" %>><%= r.getRoleName() %></option>
                <% } %>
            </select>
    ...
    <table>
        ...
        <tbody>
            ...
            List<Employees> list2;

            if (roleId != null && !roleId.isEmpty() && (name == null || name.isEmpty())) {
                list2 = er.getEmployeesByRole(Integer.parseInt(roleId));
            } else if (roleId != null && !roleId.isEmpty() && name != null && !name.isEmpty()) {
                list2 = er.getEmployeesByRoleAndName(Integer.parseInt(roleId), name);
            } else if (name != null && !name.isEmpty()) {
                list2 = er.getEmployeesByName(name);
            } else {
                list2 = er.getAllEmployees();
            }
